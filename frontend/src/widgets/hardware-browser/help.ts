...
export type HelpTopic = 'glossary' | 'search' | 'categories' | 'manufacturers'

/** Help topics in display order. Text: `hardwareBrowser.help.topics.<topic>.{title,body}`. */
export const HELP_TOPICS: HelpTopic[] = ['glossary', 'search', 'categories', 'manufacturers']
...
export const GLOSSARY_KEYS = ['category', 'manufacturer', 'spec'] as const
