...
# Vendored into FilaMind Flow: the only change from upstream Klipper is this
# import (originally `importlib.import_module('.shaper_defs', 'extras')`) so the
# module resolves inside this package instead of Klipper's `extras` package.
