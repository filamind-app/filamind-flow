...
| **Hardware Browser** | Search a curated reference of **3,000+** 3D-printing components — steppers, drivers, boards, sensors, hotends, fans, hosts, nozzles, extruders, filaments and more — by name, manufacturer, category, or any spec, with each result's full spec sheet. Illustrated help. | ✅ Shipped (search + UI) |
